...
public class DisplayActivitiesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getActWithType=data.getStringExtra("profileType");
        listView=(RecyclerView) findViewById(R.id.displayActlistView);
        listView.setLayoutManager(new LinearLayoutManager(DisplayActivitiesActivity.this));
        ...
        refreshListener=new SwipeRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                GetUserProfileWithType task=new GetUserProfileWithType(Constants.DEVEICEIDVALUE,Constants.SIGNATUREVALUE,getActWithType,0,10,false);
        ...
        activityInfoAdapter.setOnLoadMoreListener(new MyActivityInfoAdapter.OnLoadMoreListener() {
            ...
            public void onLoadMore() {
                ...
                GetUserProfileWithType task=new GetUserProfileWithType(Constants.DEVEICEIDVALUE,Constants.SIGNATUREVALUE,getActWithType,counter,10,true);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.HONEYCOMB) {
                    task.executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
                } else {
                    task.execute();
        ...
        textView.setText(String.format("%s%s",getActWithType.toUpperCase().charAt(0),getActWithType.substring(1)));
    }
    ...
    private class GetUserProfileWithType extends AsyncTask<Void,Void,ArrayList> {
        ...
        GetUserProfileWithType(String deviceId,String signature,String type,int offset,int limit,boolean more){
            mEquipId=deviceId;
    ...
    public void eventDetailAction(View view){
        ...
        Intent intent=new Intent(DisplayActivitiesActivity.this,EventDetailActivity.class);
    ...
    public void userImageAction(View view){
        ...
        Intent intent=new Intent(DisplayActivitiesActivity.this,UserDetailActivity.class);
    ...
    public void userCommentsAction(View view){
        ...
        Intent intent=new Intent(DisplayActivitiesActivity.this,CommentsActivity.class);
    ...
    private class LikeActivityTask extends AsyncTask<Void,Void,JSONObject>{
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            if (jsonObject==null){
                Toast.makeText(DisplayActivitiesActivity.this, "server error", Toast.LENGTH_SHORT).show();
            }else{
                try {
