...
//		a.recycle();
    ...
    private void freeCameraResource() {
        Log.d("MovieRecorderView","freeCameraResource");
        if (mCamera != null) {
    ...
    private void createRecordDir() {
        String sampleDir= Tools.checkAppDirectory("video");
        try {
            mVecordFile=File.createTempFile("recording",".mp4",new File(sampleDir));
        } catch (Throwable e) {
            e.printStackTrace();
        }
    }
    ...
    private void initRecord() throws IOException {
        ...
        mMediaRecorder.setOnInfoListener(new MediaRecorder.OnInfoListener() {
            ...
            public void onInfo(MediaRecorder mr, int what, int extra) {
                    Log.d("MovieRecorderView",String.format("MovieRecorderView what %s extra %s",what,extra));
            }
        });
        ...
        mMediaRecorder.setVideoEncodingBitRate(1 * mWidth * mHeight);// 设置帧频率，然后就清晰了
    ...
    public void stopRecord() {
        Log.d("MovieRecorderView","stopRecord");
        ...
        if (mMediaRecorder != null) {
            ...
            try {
                Log.d("MovieRecorderView","mMediaRecorder stop");
                mMediaRecorder.stop();
    ...
    private void releaseRecord() {
        Log.d("MovieRecorderView","releaseRecord");
        if (mMediaRecorder != null) {
            mMediaRecorder.setOnErrorListener(null);
